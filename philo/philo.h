...
/*   Updated: 2025/01/07 16:18:03 by vvasiuko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	unsigned int	num_ph; // number of philosophers
	uint64_t		tt_die; // time to die in ms
	uint64_t		tt_eat; // time to eat in ms
